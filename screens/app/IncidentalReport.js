...
import {
    fetchAllincidentalsData, fetchAllincidentalsDataSearch
} from "../../features/getllincidentals/getllincidentals";
...
const IncidentalReport = ({ navigation }) => {
...
const changeLng = lng => {
  ...
  const {incidentals_error,
    all_incidental,
    incidental_isLoading } = useSelector(
    (state) => state.getllincidentals
  );
...
const [location_Spt, setLocation_Spt] = useState(
  ...
  const onRefresh = () => {
    setRefreshing(true);
    dispatch(fetchAllincidentalsData(currentSpt));
    ...
    <Center px="1">
      ...
      >
        ...
        >
          ...
          >
            {currentusertype == `BOSS` ? `${t('cause')}: ` + benefit : ""}
          </Text>
        </View>
  ...
  const createDynamicTable = () => {
    let table = "";
    for (let i = 0; i < all_incidental.length; i++) {
      const item = all_incidental[i];
      table += `
        <tr height="35px" >
        <td style="font-size: 12px;font-family: 'Open Sans', sans-serif; color: #1e2b33; font-weight: normal;  vertical-align: top; padding: 0 0 7px;" align="left" width="150">${i+1}. ${item.usernames}</td>
        <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33; font-weight: normal;  vertical-align: top; padding: 0 0 7px;" align="left" width="100">${item.product_name}</td>
          <td style="font-size: 12px;font-family: 'Open Sans', sans-serif; color: #1e2b33; font-weight: normal;  vertical-align: top; padding: 0 0 7px;" align="left" width="150">${item.quantity}</td>
          <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33; font-weight: normal;  vertical-align: top; padding: 0 0 7px;" align="left" width="100">${item.cause}</td>
          <td style="font-size: 9px; font-family: 'Open Sans', sans-serif; color: #1e2b33; font-weight: bold;  vertical-align: top; padding: 0 0 7px;" align="right" width="150">${formatDateTime(item.created_at)}</td>
        </tr>
          ...
          <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
            ...
            <tr>
              ...
              <tr>
                ...
                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                  <strong> ${all_incidental.length}</strong>
                </td>
              </tr>
      ...
      <NativeBaseProvider>
        ...
        >
          <View style={styles.container}>
            ...
            >
              {t('all')} {all_incidental.length} {all_incidental.length == 1 ? "incidental" : "incidentals"}{" "}
              {t('list')}
            </Text>
            ...
            <TouchableOpacity
              ...
              <Input
                ...
                onChangeText={(e) => {
                  setSearchQuery(e);
                  dispatch(fetchAllincidentalsDataSearch(currentSpt, e));
                }}
                value={searchQuery}
                InputLeftElement={
                  <Icon
          ...
          <Center>
            ...
            >
              <AlertDialog.Content>
                ...
                <AlertDialog.Header>{t('incquick')}</AlertDialog.Header>
                <AlertDialog.Body>
                  <Text>
                  {t('incmes')}  {SelectedName}.
                  </Text>
                </AlertDialog.Body>
                <AlertDialog.Footer>
                  <Button.Group space={2}>
            ...
            >
              <AlertDialog.Content>
                ...
                <AlertDialog.Body>
                  <Text>{t('incdel')} {SelectedName} {t('now')}</Text>
                </AlertDialog.Body>
                <AlertDialog.Footer>
                  <Button.Group space={2}>
                    <Button
...
export default IncidentalReport;
