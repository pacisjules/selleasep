...
import {
  fetchSearchUsersSalesData,
  fetchuserssalestotals,
  fetchAllSalesDatabyUser,
...
const Getsalesbyuser = ({ navigation }) => {
  ...
  const choosedUser=params.user_id
  ...
  const onRefresh = () => {
    setRefreshing(true);
    dispatch(fetchAllSalesDatabyUser(currentCompany, choosedDate,choosedUser));
    dispatch(fetchuserssalestotals(choosedUser, choosedDate));
