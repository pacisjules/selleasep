...
import {
  fetchSearchPickingSalesData,
  fetchPickingtotals,
  fetchAllPickingSalesData,
...
const RedPick = ({ navigation }) => {
  ...
  const onRefresh = () => {
    setRefreshing(true);
    dispatch(fetchAllPickingSalesData(currentCompany, currentSpt, choosedDate));
    dispatch(fetchPickingtotals(currentSpt, choosedDate));
          ...
          <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
            ...
            <tr>
              ...
              <tr>
                ...
                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                  <strong>${t('total')} ${t('amount')}:  ${new Intl.NumberFormat("en-US", {
                    style: "currency",
                    currency: "RWF",
                  }).format(
                  ...
                  <Button.Group space={2}>
                    ...
                    >
                      {isLoading ? (
                        ...
                        <Text style={{ color: "white" }}>Re{t('remove')}</Text>
                      )}
                    </Button>
                  </Button.Group>
                </AlertDialog.Footer>
